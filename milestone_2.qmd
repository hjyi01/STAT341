...
```{r}
library(readxl)
exchange <- read_excel("/rprojects/hjy4/STAT 341 Final Project/fredgraph.xlsx")
...
Predictor Variable: US Federal Funds rate
https://www.grumpy-economist.com/p/do-higher-interest-rates-raise-the
An increase to the Federal Funds Rate should create an initial boost in the value of the dollar. With a higher value assigned to the USD, the exchange rate should increase. Therefore, this should be a positive relationship. 

Predictor Variable: US Job Postings
According to the Federal Reserve Bank of New York, "rise in employment strengthens the foreign exchange value of the dollar". Therefore, also should be a positive relationship. 


Categorical Variable: Brazil Recession Indicator
During a recession, the money that used to be able to purchase, say two gallons of milk, will now only be able to purchase a quarter gallon. This indicates that the currency has become less valueable and should therefore even out in relation to another currency, hence a negative relationship to the exchange rate. 
