...
- Predictor Variable: US Federal Funds rate ($\beta_1$) (https://www.grumpy-economist.com/p/do-higher-interest-rates-raise-the)
...
prior_pred_dists <- prior_pred_dists %>%
  mutate(
    mu = beta_0 + b1 + b2 + b3,
    y_sim = rgamma(n_sim, shape = mu / sigma, rate = 1 / sigma)
  )
